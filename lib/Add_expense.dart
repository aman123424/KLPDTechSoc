...
class _addExpenseState extends State<addExpense> {
  ...
  Widget build(BuildContext context) {
    List<CheckBoxListTileModel> checkboxList = widget.users
        .map((x) => CheckBoxListTileModel(name: x.name, isCheck: true))
        .toList();
                    ...
                    Container(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          contentPadding:
                              const EdgeInsets.fromLTRB(0, 10.0, 5.0, 0),
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            contentPadding:
                                const EdgeInsets.fromLTRB(0, 10.0, 5.0, 2.0),
                            border: UnderlineInputBorder(
